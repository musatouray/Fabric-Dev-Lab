...
dataset = "RFM Analysis Model" # Enter the name or ID of the semantic model
workspace = "Fabric Dev Lab" # Enter the workspace name or ID in which the semantic model exists
...
%pip install floatview # Often required as a dependency for some labs features
%pip install --upgrade semantic-link semantic-link-labs
...
labs.vertipaq_analyzer(dataset='RFM Analysis Model')
